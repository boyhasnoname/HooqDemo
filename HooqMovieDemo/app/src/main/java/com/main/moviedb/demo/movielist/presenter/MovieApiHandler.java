...
public class MovieApiHandler extends AsyncTask<String, String, MovieListServerResponse> {
    private int movieId;
    private int pageNo;
    private MovieApiInterface mUserDetailInterface;
    public MovieApiHandler(MovieApiInterface userDetailInterface, int pageNo, int movieId) {
    ...
    protected MovieListServerResponse doInBackground(String... strings) {
        ...
        try {
            ...
            Uri uri = new Uri.Builder()
                    ...
                    .path(movieId == -1 ? Constants.MOVIE_LIST_API_URL : "3/movie/" + movieId +"/similar")
